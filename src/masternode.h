...
// Copyright (c) 2020 Coon developers
...
#define MASTERNODE_EXPIRATION_SECONDS          (365*24*60*60) //Old 65*60
#define MASTERNODE_REMOVAL_SECONDS             (365*24*60*60) //Old 70*60
...
// The Masternode Class. For managing the darksend process. It contains the input of the 1000Coon, signature to prove
