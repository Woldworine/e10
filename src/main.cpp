...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 7000000 * COIN;   // 7M Premine
    }
        else if(pindexBest->nHeight < 1000)
    {
        nSubsidy = 0.0001 * COIN;
    }
        else if(pindexBest->nHeight < 712000)
    {
        nSubsidy = 1 * COIN;
    }
        else if(pindexBest->nHeight < 1424000)
    {
        nSubsidy = 0.5 * COIN;
    }
        else if(pindexBest->nHeight < 2136000)
    {
        nSubsidy = 0.25 * COIN;
    }
        else if(pindexBest->nHeight < 2848000)
    {
        nSubsidy = 0.125 * COIN;
    }
        else if(pindexBest->nHeight < 3560000)
    {
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 24.725 * COIN;
    }
        else if(pindexBest->nHeight < 2848000)
    {
        nSubsidy = 12.385 * COIN;
    }
        else if(pindexBest->nHeight < 3560000)
    {
        nSubsidy = 5.9375 * COIN;
    }
        else
    {
        nSubsidy = 5.9375 * COIN;
...
{
    int64_t ret = blockValue * 0.989898; //98.9898% for masternodes from POS
