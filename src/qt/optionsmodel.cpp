...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizecoonAmount"))
        settings.setValue("nAnonymizecoonAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizecoonAmount = settings.value("nAnonymizecoonAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizecoonAmount"))
        SoftSetArg("-anonymizecoonamount", settings.value("nAnonymizecoonAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizecoonAmount:
            nAnonymizecoonAmount = value.toInt();
            settings.setValue("nAnonymizecoonAmount", nAnonymizecoonAmount);
            emit anonymizecoonAmountChanged(nAnonymizecoonAmount);
            break;
        default:
            break;
        }
