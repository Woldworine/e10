...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\coon
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\coon
    // Mac: ~/Library/Application Support/coon
    // Unix: ~/.coon
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "coon";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "coon.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "coond.pid"));
