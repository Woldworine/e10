...
static const int64_t DARKSEND_COLLATERAL = (2000000*COIN); //2000000
...
#define MASTERNODE_EXPIRATION_SECONDS          (365*24*60*60) //Old 365*24*60*60
#define MASTERNODE_REMOVAL_SECONDS             (365*24*60*60) //Old 365*24*60*60
...
inline int64_t MasternodeCollateral(int nHeight) { return 2000000; } // 2M COON required as collateral
